...
public class MultipleStateSliderEntry extends GuiConfigEntries.NumberSliderEntry
{
    protected final int beforeIndex;
    protected final int defaultIndex;
    protected int       currentIndex;

    public MultipleStateSliderEntry(GuiConfig owningScreen, GuiConfigEntries owningEntryList, IConfigElement<String> configElement)
    {
